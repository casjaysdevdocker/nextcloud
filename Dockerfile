# Docker image for nextcloud using the alpine template
ARG IMAGE_NAME="nextcloud"
ARG PHP_SERVER="nextcloud"
ARG BUILD_DATE="Sun Jul  7 03:00:44 PM EDT 2024"
...
ARG IMAGE_REPO="casjaysdevdocker/nextcloud"
ARG IMAGE_VERSION="latest"
ARG CONTAINER_VERSION=""

ARG PULL_URL="casjaysdevdocker/docker"
...
ENV HOSTNAME="casjaysdev-nextcloud"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/nextcloud" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/nextcloud" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/nextcloud" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/nextcloud" \
