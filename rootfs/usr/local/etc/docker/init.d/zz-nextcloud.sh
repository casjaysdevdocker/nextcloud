...
# set scripts pid dir
RUN_DIR="/run/nextcloud"
# set log directory
LOG_DIR="/data/logs/nextcloud"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
...
# root user name
root_user_name="${NEXT_CLOUD_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${NEXT_CLOUD_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${NEXT_CLOUD_USER_NAME:-}"
# normal user password
user_pass="${NEXT_CLOUD_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='nextcloud'
# command arguments
EXEC_CMD_ARGS=''
# execute script before
EXEC_PRE_SCRIPT='sleep 60'
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/env/nextcloud.script.sh" ] && . "$CONF_DIR/env/nextcloud.script.sh"
# Overwrite the variabes
[ -f "$CONF_DIR/env/nextcloud.sh" ] && . "$CONF_DIR/env/nextcloud.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
